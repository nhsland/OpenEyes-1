...
<?php } else {?>Hosp No: <?php echo $element->event->episode->patient->hos_num?>, <?php echo Yii::app()->params['nhs_no_label']; ?>: <?php echo $element->event->episode->patient->nhsnum?> <?php }?></strong></p>
