...
class TrialPatientController extends BaseModuleController
{
	...
	{
		$model=new TrialPatient;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TrialPatient']))
		{
			$model->attributes=$_POST['TrialPatient'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('TrialPatient');
	...
	{
		$model=new TrialPatient('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TrialPatient']))
			$model->attributes=$_GET['TrialPatient'];
